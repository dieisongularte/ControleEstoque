...
function criar_linha_grid(dados) {
    var ret =
        ...
        '<td>' +
        '<a class="btn btn-primary btn-alterar" style="margin-right: 4px"><i class="glyphicon glyphicon-pencil"></i> Alterar</a>' +
        '<a class="btn btn-danger btn-excluir"><i class="glyphicon glyphicon-trash"></i> Excluir</a>' +
        '</td>' +
        '</tr >';
